...
Clauses
 ...
 возможный_рыцарь(гектор).
 возможный_рыцарь(арон).
 возможный_рыцарь(больд).
 возможный_рыцарь(вальд).
 возможный_рыцарь(виктор).
 
 возможное_животное(свинья).
 возможное_животное(козёл).
